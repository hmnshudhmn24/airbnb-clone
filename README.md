...
This is a personal project created for educational purposes only. Airbnb and all related marks are trademarks of Airbnb, Inc. This project is not affiliated with or endorsed by Airbnb.

## Acknowledgments

- Design inspiration from Airbnb
- Mock property data for demonstration only
